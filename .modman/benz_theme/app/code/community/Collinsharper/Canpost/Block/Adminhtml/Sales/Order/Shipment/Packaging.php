<?php
class Collinsharper_Canpost_Block_Adminhtml_Sales_Order_Shipment_Packaging extends Mage_Adminhtml_Block_Sales_Order_Shipment_Packaging {
    ...
    public function getConfigDataJson()
    {
        ...
        if ($shipmentId) {
            ...
            $createLabelUrl = $this->getUrl('*/sales_order_shipment/saveCpAjax', $urlParams);
            $itemsGridUrl = $this->getUrl('*/sales_order_shipment/getShippingItemsGrid', $urlParams);
